      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <Link href="/dashboard/study-buddy/ai-tutor"
          ...
          <div className="w-10 h-10 rounded-xl flex items-center justify-center"
            style={{ background: 'rgba(103,33,255,0.15)' }}>
          ...
          <div className="mt-auto flex items-center gap-1.5 text-sm font-semibold" style={{ color: '#a78bfa' }}>
            Start session
        ...
        <Link href="/dashboard/study-buddy/partner"
          className="rounded-2xl p-6 flex flex-col gap-4 transition-all duration-200 group"
          style={{ background: 'var(--bg-card)', border: '1px solid rgba(0,203,255,0.2)' }}
          onMouseEnter={(e) => (e.currentTarget.style.border = '1px solid rgba(0,203,255,0.5)')}
          onMouseLeave={(e) => (e.currentTarget.style.border = '1px solid rgba(0,203,255,0.2)')}>
          <div className="w-10 h-10 rounded-xl flex items-center justify-center"
            style={{ background: 'rgba(0,203,255,0.1)' }}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
              style={{ color: '#00CBFF' }}>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
          ...
          <div className="mt-auto flex items-center gap-1.5 text-sm font-semibold" style={{ color: '#00CBFF' }}>
            Find a partner
            <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
