    ...
    <>
      <div className="text-center">
        <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"
          ...
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#FDCF6D' }}>
        ...
        <div className="mt-6 rounded-xl p-4 text-left"
          ...
          <p className="text-sm font-medium mb-1" style={{ color: '#FDCF6D' }}>What happens next?</p>
        ...
        <p className="mt-6 text-xs" style={{ color: 'var(--text-faint)' }}>
          ...
          <Link href="/signup" style={{ color: '#00CBFF' }}>
            sign up again
          </Link>{" "}
